...
namespace MauiApp1
{
    public class CardImageManager
    {
        ...
        {
            InitializeCardImageSources();
        }

        private void InitializeCardImageSources()
        {
            cardImageSources = new Dictionary<string, FileImageSource>
            {
        ...
        public FileImageSource GetCardImageSource(string cardKey)
        {
